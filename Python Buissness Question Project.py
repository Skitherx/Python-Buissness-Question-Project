...
#forex(Real time curreny exchange), matplotlib(Math, Supports Seaborn, Exception Handling)
import pandas as pd
...
#Makes seperate list for tv's with certain features
...
ratings_table.plot.scatter(x = 'Stars', y = 'Current Price', yticks = [100,200,300,400,500,600,700,800,900,1000,1100,1200,1300])
